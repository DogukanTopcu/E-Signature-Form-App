        ...
        private SmartCardManager()
        {
            try
            {
                ...
                if (terminals == null || terminals.Length == 0)
                    throw new SmartCardException("No card reader found with card inserted.");

                if (terminals.Length > 1)
                    throw new SmartCardException("Multiple card readers found.");

                Console.WriteLine("Number of card reader : " + terminals.Length);
